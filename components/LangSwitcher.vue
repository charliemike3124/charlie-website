<template>
    <div class="flex">
        <span class="cursor-pointer" ref="enRef" @click="locale = 'en'">en <UiHoverUnderline /> </span>
        <svg
        ...
        <span class="cursor-pointer" ref="esRef" @click="locale = 'es'">es <UiHoverUnderline /> </span>
    </div>
</template>
