            ...
            <div class="text-center text-sm flex">
                <div v-for="(l, i) in links" :key="i" class="m-5">
                    <a class="cursor-pointer m-auto" :href="l.href"
                        >{{ l.name }}
                        <ui-hover-underline> </ui-hover-underline>
                    </a>
                </div>
            </div>
            <div class="flex">
                <span class="cursor-pointer" ref="enRef" @click="locale = 'en'">en <ui-hover-underline> </ui-hover-underline></span>
                <svg
                ...
                <span class="cursor-pointer" ref="esRef" @click="locale = 'es'">es <ui-hover-underline> </ui-hover-underline></span>
            </div>
        </nav>
